...
signals:
	...
	void DrawLineSignal(QPoint Begin, QPoint End);
...
class ScrollScaleWithIndex : public ScrollScale
{
	Q_OBJECT
public:
	ScrollScaleWithIndex(const int index,QWidget *parents = Q_NULLPTR);

signals:
	void ImgClicked(int index);
